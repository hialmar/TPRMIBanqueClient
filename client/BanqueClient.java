...
public class BanqueClient {
	...
	public static void main(String[] args) throws MalformedURLException, RemoteException, NotBoundException {
		...
		while(nonFini) {
			...
			System.out.println("5- demander des notifications");
			...
			try {
				...
				case 5:
					...
					System.out.println("Quel est l'id :");
					id = scan.nextLine();
					// on essaie de s'abonner aux notifications
					try {
						soucheBanque.ajouterNotification(id, notif);
					} catch (CompteInexistant e) {
						System.out.println("Le compte n'existe pas");
					} catch (NotificationPresente e) {
						System.out.println("Notification déjà présente");
					}
		...
		// on arrête l'objet serveur RMI qui permet de récupérer les notifications
		UnicastRemoteObject.unexportObject(notif, false);
	}
